...
ALARM_PATH := $(CUSTOM_PRODUCT_DIR)/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := $(CUSTOM_PRODUCT_DIR)/prebuilt/common/media/audio/notifications
RINGTONE_PATH := $(CUSTOM_PRODUCT_DIR)/prebuilt/common/media/audio/ringtones
